...
export function HomeRegatta() {
  return (
    <section className="relative bg-bg-surface text-text-primary overflow-hidden px-6 md:px-14 pt-20 md:pt-[140px] pb-20 md:pb-[140px]">
      <div className="relative max-w-container mx-auto grid gap-12 md:gap-16 lg:grid-cols-[1.2fr_1fr] lg:items-center">
        <Reveal variant="cinematic">
          <div className="relative aspect-[5/4] overflow-hidden rounded shadow-soft">
            <Image
              src="/img/06092025_regatta-19.jpg"
              alt="Boote der Helgoländer Herbstregatta"
              fill
        ...
        <Reveal variant="cinematic" delay={0.15}>
          <div>
            ...
            <p className="body-copy mt-6 max-w-xl">
              Jährlich Anfang September. Eine Wettfahrt für seegängige Yachten, einmal um Insel und Düne, gewertet nach Yardstick.
              Veranstalter ist der Wassersportclub Helgoland.
            </p>
            <p className="body-copy mt-4 max-w-xl">
              Daneben sind wir Mitveranstalter der Nordseewoche zu Pfingsten und richten den Störtebeker Opti-Cup für den
              Nachwuchs aus.
            </p>
            <Link
              href="/regatten"
